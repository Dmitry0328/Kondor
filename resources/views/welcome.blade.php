            ...
            @php
                ...
                */
                ...
                foreach ($featuredBuilds as $index => $build) {
                    ...
                    $featuredBuilds[$index]['fps_profiles'] = $fpsProfiles;
                    $featuredBuilds[$index]['fps_lookup'] = $fpsLookup;
        ...
        <script>
            (() => {
                ...
                const updateFpsScene = (state) => {
                    ...
                    if (fpsMobileTitle) {
                        fpsMobileTitle.textContent = game.name;
                    }
