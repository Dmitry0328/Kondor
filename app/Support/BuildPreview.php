...
class BuildPreview
{
    ...
    ): array
    {
        ...
        $build->forceFill([
            ...
            'youtube_enabled' => array_key_exists('youtube_enabled', $previewAttributes)
                ? (bool) $previewAttributes['youtube_enabled']
                : (bool) ($record?->youtube_enabled ?? false),
            'youtube_url' => YoutubeVideo::sanitize($previewAttributes['youtube_url'] ?? $record?->youtube_url),
    ...
    protected static function validatePersistData(array $persistData, ?Build $record = null): array
    {
        ...
        return Validator::make($persistData, [
            ...
            'youtube_url' => [
                Rule::requiredIf((bool) ($persistData['youtube_enabled'] ?? false)),
                'nullable',
                'url',
                'max:2048',
            ],
